...
public class LittleTilesBETransformer
        implements MovedBlockTransformerRegistries.BlockEntityTransformer {
    ...
    public void transform(BlockEntity be, StructureTransform transform) {
        ...
        team.creative.creativecore.common.util.math.transformation.Rotation ltRot;

        switch (axis) {
            case Y:
                ltRot =
                        team.creative.creativecore.common.util.math.transformation.Rotation.Y_CLOCKWISE;
                break;

            case X:
                ltRot =
                        team.creative.creativecore.common.util.math.transformation.Rotation.X_CLOCKWISE;
                break;

            case Z:
                ltRot =
                        team.creative.creativecore.common.util.math.transformation.Rotation.Z_CLOCKWISE;
                break;
